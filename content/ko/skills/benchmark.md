...
tags: ["benchmark", "성능", "Core Web Vitals", "Lighthouse", "번들 크기", "gstack"]
category: "브라우저/QA"
---
...
**SKILL.md 파일 위치**: `~/.claude/skills/benchmark/SKILL.md`
...
- [browse](./browse.md) — 단일 시나리오 빠른 브라우저 검증 (Benchmark의 기반 엔진)
- [qa](./qa.md) — 전체 사이트 품질 스코어링
- [canary](./canary.md) — 배포 후 성능 회귀 실시간 감지
