...
tags: ["gstack", "헤드리스 브라우저", "QA 자동화", "E2E", "스크린샷", "반응형"]
category: "브라우저/QA"
---
...
**SKILL.md 파일 위치**: `~/.claude/skills/gstack/SKILL.md`
...
- [browse](./browse.md) — GStack 기반 단일 시나리오 빠른 검증 (더 간단한 경우)
- [canary](./canary.md) — GStack 기반 배포 후 헬스 체크 자동화
- [gstack-upgrade](./gstack-upgrade.md) — GStack 엔진 최신 버전 업그레이드
