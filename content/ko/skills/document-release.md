...
tags: ["document-release", "문서", "CHANGELOG", "README", "릴리즈"]
category: "배포"
---
...
**SKILL.md 파일 위치**: `~/.claude/skills/document-release/SKILL.md`
...
- [finishing-a-development-branch](./finishing-a-development-branch.md) — 브랜치 완료 후 통합 (Document Release와 연계)
- [ship](./ship.md) — 배포 파이프라인 (Document Release 자동 제안 포함)
- [land-and-deploy](./land-and-deploy.md) — 배포 후 검증 파이프라인
