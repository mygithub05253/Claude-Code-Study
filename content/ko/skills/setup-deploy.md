...
promptVersion: "ko-v1"
tags: ["배포", "CI/CD", "gstack", "Vercel", "설정"]
category: "배포"
...
**SKILL.md 파일 위치**: `~/.claude/skills/setup-deploy/SKILL.md`
...
### 3단계 — GitHub Actions 워크플로우 자동 생성
...
- [land-and-deploy](./land-and-deploy.md) — PR 머지 + 배포 자동화
- [ship](./ship.md) — PR 생성 스킬
- [canary](./canary.md) — 프로덕션 헬스 체크
