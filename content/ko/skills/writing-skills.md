...
promptVersion: "ko-v1"
tags: ["스킬작성", "TDD", "메타스킬", "CSO", "SKILL.md"]
category: "메타"
...
**SKILL.md 파일 위치**: `~/.claude/skills/writing-skills/SKILL.md`
...
- [using-superpowers](./using-superpowers.md) — 스킬 카탈로그 활용법 (메타 스킬)
- [test-driven-development](./test-driven-development.md) — TDD 원칙 (스킬 작성에도 적용)
- [verification-before-completion](./verification-before-completion.md) — 스킬 완성 전 검증 원칙
