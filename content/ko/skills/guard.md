...
tags: ["guard", "안전", "파괴적 명령어", "편집 범위", "프로덕션", "careful", "freeze"]
category: "품질/안전"
---
...
**SKILL.md 파일 위치**: `~/.claude/skills/guard/SKILL.md`
...
- [careful](./careful.md) — 위험 명령어 경고만 단독 활성화
- [freeze](./freeze.md) — 편집 범위 제한만 단독 활성화
- [cso](./cso.md) — 보안 취약점 전체 감사 (Guard와 상호 보완)
