...
tags: ["connect-chrome", "브라우저", "실시간 QA", "Side Panel", "gstack"]
category: "브라우저/QA"
---
...
**SKILL.md 파일 위치**: `~/.claude/skills/connect-chrome/SKILL.md`
...
- **Side Panel을 통한 AI 사고 과정 관찰**: Side Panel의 활동 피드는 Claude가 페이지를 어떻게 이해하는지를 보여준다. 이 피드를 관찰하면 Claude의 실수를 사전에 예방할 수 있다.

## 관련 리소스

- [browse](./browse.md) — 헤드리스 브라우저 테스트 (빠른 자동화)
- [gstack](./gstack.md) — 범용 브라우저 자동화 엔진
- [setup-browser-cookies](./setup-browser-cookies.md) — 쿠키/세션 사전 설정
