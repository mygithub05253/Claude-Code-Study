...
tags: ["dispatching-parallel-agents", "병렬", "멀티에이전트", "서브에이전트"]
category: "에이전트"
---
...
**SKILL.md 파일 위치**: `~/.claude/skills/dispatching-parallel-agents/SKILL.md`
...
- [subagent-driven-development](./subagent-driven-development.md) — 세션 내 서브에이전트 기반 개발
- [using-git-worktrees](./using-git-worktrees.md) — 병렬 에이전트의 파일 충돌 방지
- [checkpoint](./checkpoint.md) — 에이전트 작업 상태 저장 및 재개
